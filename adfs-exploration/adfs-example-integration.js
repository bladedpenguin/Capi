...
var adfsSigningPublicKey = fs.readFileSync('cert/star_catalystdevworks_com.crt'); // Exported from ADFS
...
var strategy = new OAuth2Strategy({
        authorizationURL: 'https://api.catalystdevworks.com/adfs/oauth2/authorize',
        tokenURL: 'https://api.catalystdevworks.com/adfs/oauth2/token',
